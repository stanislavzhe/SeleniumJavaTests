...
//    Применить паттерн Page Object и Page Factory покрыть тестами следующий сценарий :
...
//    Сравнить что значения в блоке Payment соответствуют значениям на Cart  Summary
    ...
    public void createAccountTest() {
        ...
        TopMenuNavigation topMenuNavigation = new TopMenuNavigation(driver);
        topMenuNavigation.clickOnSignButton();
        ...
        accountCreationPage.typeCustomersFirstName(cutomersFirstName);
        accountCreationPage.typeCustomersLastName(cutomersLastName);
